var capacitorCapacitorGoogleMaps = (function (exports, core, markerclusterer) {
  ...
  const CapacitorGoogleMaps = core.registerPlugin("CapacitorGoogleMaps", {
    web: () =>
      Promise.resolve()
        ...
        .then((m) => new m.CapacitorGoogleMapsWeb()),
  });
  CapacitorGoogleMaps.addListener("isMapInFocus", (data) => {
    ...
    const internalId =
      (_a = elem === null || elem === void 0 ? void 0 : elem.dataset) ===
        null || _a === void 0
        ? void 0
        : _a.internalId;
  ...
  class GoogleMap {
    ...
    static async create(options, callback) {
      ...
      if (core.Capacitor.isNativePlatform()) {
        ...
        const getMapBounds = () => {
          ...
          const mapRect =
            (_b =
              (_a = newMap.element) === null || _a === void 0
                ? void 0
    ...
    async setOnCameraMoveStartedListener(callback) {
      ...
      if (callback) {
        this.onCameraMoveStartedListener =
  ...
  class CapacitorGoogleMapsWeb extends core.WebPlugin {
        ...
        if (cluster.markers != undefined) {
          for (const marker of cluster.markers) {
            ...
            items.push({
              markerId: markerId,
              latitude:
                (_a = marker.getPosition()) === null || _a === void 0
                  ? void 0
                  : _a.lat(),
              longitude:
                (_b = marker.getPosition()) === null || _b === void 0
                  ? void 0
                  : _b.lng(),
    ...
    async enableTrafficLayer(_args) {
      var _a;
      const trafficLayer =
        (_a = this.maps[_args.id].trafficLayer) !== null && _a !== void 0
          ? _a
      ...
      this.maps[_args.id].markerClusterer = new markerclusterer.MarkerClusterer(
        {
          ...
          algorithm: new markerclusterer.SuperClusterAlgorithm({
            minPoints:
              (_a = _args.minClusterSize) !== null && _a !== void 0 ? _a : 4,
          }),
    ...
    async disableClustering(_args) {
      var _a;
      (_a = this.maps[_args.id].markerClusterer) === null || _a === void 0
        ? void 0
        : _a.setMap(null);
    ...
    async setMapListeners(mapId) {
      ...
      map.addListener("idle", async () => {
        ...
        this.notifyListeners("onCameraIdle", {
          ...
          bounds: bounds,
          latitude:
            (_a = map.getCenter()) === null || _a === void 0
              ? void 0
              : _a.lat(),
          longitude:
            (_b = map.getCenter()) === null || _b === void 0
              ? void 0
              : _b.lng(),
          tilt: map.getTilt(),
          zoom: map.getZoom(),
      ...
      map.addListener("click", (e) => {
        ...
        this.notifyListeners("onMapClick", {
          mapId: mapId,
          latitude:
            (_a = e.latLng) === null || _a === void 0 ? void 0 : _a.lat(),
          longitude:
            (_b = e.latLng) === null || _b === void 0 ? void 0 : _b.lng(),
        });
      });
        ...
        iconImage = {
          ...
          scaledSize: marker.iconSize
            ? new google.maps.Size(
                marker.iconSize.width,
                marker.iconSize.height
              )
            : null,
