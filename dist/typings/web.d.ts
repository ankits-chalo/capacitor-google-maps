...
export declare class CapacitorGoogleMapsWeb
  extends WebPlugin
  implements CapacitorGoogleMapsPlugin
{
  ...
  enableTouch(_args: { id: string }): Promise<void>;
  disableTouch(_args: { id: string }): Promise<void>;
  setCamera(_args: CameraArgs): Promise<void>;
  getMapType(_args: { id: string }): Promise<{
    type: string;
  }>;
  ...
  getMapBounds(_args: { id: string }): Promise<LatLngBounds>;
