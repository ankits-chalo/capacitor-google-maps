...
CapacitorGoogleMaps.addListener("isMapInFocus", (data) => {
  ...
  const internalId =
    (_a = elem === null || elem === void 0 ? void 0 : elem.dataset) === null ||
    _a === void 0
      ? void 0
      : _a.internalId;
...
class CapacitorGoogleMapsWeb extends core.WebPlugin {
  ...
  async importGoogleLib(apiKey, region, language) {
    if (this.gMapsRef === undefined) {
      const lib = await Promise.resolve().then(function () {
  ...
  async setMapListeners(mapId) {
    ...
    map.addListener("idle", async () => {
      ...
      this.notifyListeners("onCameraIdle", {
        ...
        bounds: bounds,
        latitude:
          (_a = map.getCenter()) === null || _a === void 0 ? void 0 : _a.lat(),
        longitude:
          (_b = map.getCenter()) === null || _b === void 0 ? void 0 : _b.lng(),
        tilt: map.getTilt(),
        zoom: map.getZoom(),
      });
    });
