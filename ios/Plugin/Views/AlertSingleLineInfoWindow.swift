//
//  AlertSingleLineInfoWindow.swift
//  App
//
...
class AlertSingleLineInfoWindow: UIView {
    ...
    class func instanceFromNib() -> AlertSingleLineInfoWindow {
        return UINib(nibName: "AlertSingleLineInfoWindow", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! AlertSingleLineInfoWindow
    }
}
