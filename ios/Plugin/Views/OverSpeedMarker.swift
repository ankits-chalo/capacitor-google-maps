...
class OverSpeedMarker: UIView {
    ...
    class func instanceFromNib() -> OverSpeedMarker {
        return UINib(nibName: "OverSpeedMarker", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! OverSpeedMarker
    }
}
