...
class LastUpdatedInfoWindow: UIView {
    ...
    class func instanceFromNib() -> LastUpdatedInfoWindow {
        return UINib(nibName: "LastUpdatedInfoWindow", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! LastUpdatedInfoWindow
    }
}
