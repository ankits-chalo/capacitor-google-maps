...
class AlertStopMarker: UIView {
    ...
    class func instanceFromNib() -> AlertStopMarker {
        return UINib(nibName: "AlertStopMarker", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! AlertStopMarker
    }
}
